    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-center mb-6">
          Welcome to Kill Tony Universe
        </h1>
        <p className="text-lg text-center mb-8 max-w-2xl mx-auto">
          Your ultimate destination for exploring the Kill Tony universe. Discover episodes, 
          track your favorite comedians, and join our community of passionate fans.
        </p>
